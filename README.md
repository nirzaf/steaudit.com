# Salem Taleb Efaifa Auditing & Consultancy
...
- **Objectivity**: We perform duties in an unbiased manner, based on informed analysis, and a clear understanding of the operations affected.
...
- `src/app/`: Route segments, layouts, and pages (`/`, `/about`, `/services`, `/partners`, `/contact`).
- `src/assets/`: Static assets like images and animations.
- `src/components/`: Reusable UI components.
- `src/config/`: Configuration files (e.g., SEO).
- `src/data/`: Data files (e.g., services).
- `src/lib/`: Library helpers (e.g., Supabase client, metadata builder).
